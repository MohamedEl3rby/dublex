        ...
        child: new Column(
          children: [
            ...
            new Container(
              child: new Column(
                children: [
                  new Text(" Gift codes are free gifts that can be used to ",style: TextStyle(color: Colors.red),),
                  new Text(" activate the app ",style: TextStyle(color: Colors.red),),
            ...
            new Container(
              ...
              child: new Row(
                children: [
                  ...
                  new Text("Gift Code  |",style: TextStyle(color: Colors.white,fontSize: 10.0),),
                  new Text("Type  |",style: TextStyle(color: Colors.white,fontSize: 10.0),),
                  new Text("Source  |",style: TextStyle(color: Colors.white,fontSize: 10.0),),
                  ...
                  new Text("  Redeemed At    |",style: TextStyle(color: Colors.white,fontSize: 10.0),),
